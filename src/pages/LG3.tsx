  ...
  const antiquedaProducts = [
    {
      ...
      purchaseUrl: "https://seguro.welong.com.br/r/QBY29C6JEJ?utm_source=lg3&utm_medium=lg3&utm_campaign=eml"
    },
    {
      ...
      showDiscountBadge: true,
      discountAmount: "R$ 80",
      purchaseUrl: "https://seguro.welong.com.br/r/9L9UN5MH0K?utm_source=lg3&utm_medium=lg3&utm_campaign=eml"
    },
    {
      ...
      showDiscountBadge: true,
      discountAmount: "R$ 40",
      purchaseUrl: "https://seguro.welong.com.br/r/KLF7DEKSW5?utm_source=lg3&utm_medium=lg3&utm_campaign=eml"
    },
    {
      ...
      showDiscountBadge: true,
      discountAmount: "R$ 20",
      purchaseUrl: "https://seguro.welong.com.br/r/6RVKQ5APYU?utm_source=lg3&utm_medium=lg3&utm_campaign=eml"
    },
    {
      ...
      showDiscountBadge: true,
      discountAmount: "R$ 10",
      purchaseUrl: "https://seguro.welong.com.br/r/CCC0SPDKKZ?utm_source=lg3&utm_medium=lg3&utm_campaign=eml"
    }
  ];
  ...
  const antiFrizzProducts = [
    {
      ...
      showDiscountBadge: true,
      discountAmount: "R$ 180",
      purchaseUrl: "https://seguro.welong.com.br/r/GVVRX4SMKV?utm_source=lg3&utm_medium=lg3&utm_campaign=eml"
    },
    {
      image: antifrizz6Img,
      ...
      showDiscountBadge: true,
      discountAmount: "R$ 80",
      purchaseUrl: "https://seguro.welong.com.br/r/AMXSPBBJXG?utm_source=lg3&utm_medium=lg3&utm_campaign=eml"
    },
    {
      ...
      showDiscountBadge: true,
      discountAmount: "R$ 40",
      purchaseUrl: "https://seguro.welong.com.br/r/IIDRJIZWDF?utm_source=lg3&utm_medium=lg3&utm_campaign=eml"
    },
    {
      image: antifrizz3Img,
      ...
      showDiscountBadge: true,
      discountAmount: "R$ 20",
      purchaseUrl: "https://seguro.welong.com.br/r/R9UWZJHO8V?utm_source=lg3&utm_medium=lg3&utm_campaign=eml"
    },
    {
      image: antifrizz1Img,
      ...
      showDiscountBadge: true,
      discountAmount: "R$ 10",
      purchaseUrl: "https://seguro.welong.com.br/r/553JDA3KRS?utm_source=lg3&utm_medium=lg3&utm_campaign=eml"
    }
  ];
      ...
      <section className="relative z-10 py-1 sm:py-8 px-0 sm:px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="text-center mb-6 sm:mb-8">
            ...
            <p className="text-base sm:text-lg md:text-xl text-foreground font-semibold mb-4 sm:mb-6 md:mb-8 px-4">
              🔥 DESCONTOS DE ATÉ 30% - APROVEITE AGORA! ⚡
            </p>
          </div>
          ...
          <div className="overflow-hidden whitespace-nowrap bg-gradient-to-r from-black-november-orange via-black-november-gold to-black-november-orange py-4 mt-4 sm:mt-6 md:mt-8 w-screen relative left-1/2 right-1/2 -ml-[50vw] -mr-[50vw] shadow-glow">
            <div className="animate-marquee inline-block text-base sm:text-lg md:text-xl text-black font-bold">
              {Array(100).fill("⚡ BLACK NOVEMBER ⚡ ATÉ 30% OFF 🔥 ÚLTIMAS UNIDADES 🔥 APROVEITE AGORA ⚡          ").join("")}
            </div>
          </div>
        </div>
      </section>
